...
class SharedPrefsExt {
  ...
  static late SharedPreferences _savedPreferences;
  static late Map<ValueName, ValueNotifier> _nameToValueNotifier;
  ...
  static _setLocalGlobal(ValueName name, dynamic value, {bool isBool: true}) {
    ValueNotifier? vn = _nameToValueNotifier[name];
    if (vn != null) {
      //update locally
      vn.value = value;
      //update globally
  ...
  static dynamic _set(bool isBool, String key, dynamic value) {
    ...
    if (isBool)
      _savedPreferences.setBool(key, value);
    else
      _savedPreferences.setInt(key, value);
