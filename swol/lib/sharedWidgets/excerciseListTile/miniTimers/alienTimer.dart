...
class AnimatedMiniAlienTimer extends StatefulWidget {
  AnimatedMiniAlienTimer({
  ...
  @override
  _AnimatedMiniAlienTimerState createState() => _AnimatedMiniAlienTimerState();
}

class _AnimatedMiniAlienTimerState extends State<AnimatedMiniAlienTimer> with SingleTickerProviderStateMixin{
