...
class ToReps{
  static double from1RMandWeight(double max, double weight, int predictionID){
    ...
    if(positiveMax && positiveWeight){
      switch(predictionID){
        case 0: return brzycki(weight, max); break;
        case 1: return mcGlothinOrLanders(weight, max); break;
        case 2: return almazan(weight, max); break;
        case 3: return epleyOrBaechle(weight, max); break;
        case 4: return oConner(weight, max); break;
        case 5: return wathan(weight, max); break;
        case 6: return mayhew(weight, max); break;
        default: return lombardi(weight, max); break;
      }
    }
    else return null;
  }
