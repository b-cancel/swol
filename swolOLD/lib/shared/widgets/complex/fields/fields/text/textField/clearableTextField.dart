...
class _TextFieldWithClearButtonState extends State<TextFieldWithClearButton> {
    ...
    return Flexible(
      child: IntrinsicHeight(
        child: Row(
          ...
          children: <Widget>[
            (widget.editOneAtAtTime)
                ? EditOneAtATimeButtons(
                    undo: () => setCtrlWithValue(),
                    showTopButton: (isEditing.value &&
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      TextField(
                        ...
                        keyboardType: TextInputAction.newline != textInputAction
                            ? TextInputType.text
  ...
  isEditingUpdate() {
    if (isEditing.value) {
      ...
      //we are saving
      if (widget.editOneAtAtTime == false ||
          (widget.editOneAtAtTime && focusNodeVN.value.hasFocus)) {
